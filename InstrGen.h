...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 105               103 102       99 98    97 96        65 64         48 47            36 35                  0
// -------------------------------------------------------------------------------------------------------------
// |                    |            |        |            |             |                |                    |
// |  InterfaceControl  |   Opcode   |  Jump  |  NodeAddr  |  ValueData  |   DatamemSel   |     OperandAddr    |
// |                    |            |        |            |             |                |                    |
// -------------------------------------------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define Interface_FIFO_0        0b110
#define Interface_FIFO_1        0b111

   
//! Struction of Instruction
typedef struct
{
    vector<int> InterfaceControl;
    int Opcode;
    vector<int> Jump;        
